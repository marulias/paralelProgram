...
void saveExperimentResults(const vector<int>& sizes, 
    ...
    ofstream file("experiment_results.txt");
    ...
    file << "2. При размере 200x200 время составило " << times[0] << " сек\n";
    file << "3. При размере 2000x2000 время составило " << times[5] << " сек\n";
    file << "4. Производительность составляет от " << mflops[0] << " до " << mflops[5] << " MFLOPS\n";
