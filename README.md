...
6. Графики
6.1 Зависимость времени выполнения от размера матрицы
...
10  |                         #    +
    |                   $    +    *
  0 |_____*___+___#___$________________________
    200   400   800   1200  1600  2000  Размер
6.2 Зависимость производительности (MFLOPS) от размера матрицы
text
MFLOPS
    |
3500|                                   $ 8 потоков
